package J_ВводВыводОператорTryСРесурсами.G_ЧтениеИЗаписьФайловFileInputStreamИFileOutputStream.ЗаписатьТекстВФайлИПрочитать;
...
public class FileWriterReaderDemo {
    public static void main(String[] args) {
        ...
        String path = "C:/Users/alext/OneDrive/Документы" +
                ...
                "/ЗаписатьТекстВФайлИПрочитать/";
        String file = "FileWriter.txt"; // Имя файла
        String filecopy = "FileWriterCopy.txt"; // Копия файла

        // Чтение посимвольно
        // FileWriter в Java представляет собой класс,
        // который используется для записи символов в текстовый файл.
        // FileWriter: Это класс из пакета java.io, предназначенный для записи символов в файл.
        // wfile: Это имя переменной, в которой будет храниться ссылка на созданный объект FileWriter.
        // Вы можете использовать это имя для взаимодействия с объектом и записи данных в файл.
        // path: Это строка, представляющая путь к директории,
        // в которой находится файл, который вы хотите создать или перезаписать.
        // file: Это строка, представляющая имя файла, который вы хотите создать
        // или перезаписать в указанной директории.
        try (FileWriter wfile = new FileWriter(path + file);
             // FileReader в Java представляет собой класс,
             // который используется для чтения символов из текстового файла.
             // FileReader: Это класс из пакета java.io, предназначенный для чтения символов из файла.
             // rfile: Это имя переменной, в которой будет храниться ссылка на созданный объект FileReader.
             // Вы можете использовать это имя для взаимодействия с объектом и чтения данных из файла.
             // path: Это строка, представляющая путь к директории,
             // в которой находится файл, который вы хотите прочитать.
             // file: Это строка, представляющая имя файла, который вы хотите прочитать в указанной директории.
