package L_ЛямбдаВыражения.N_ПредопределенныеФункциональныеИнтерфейсы.ОпределениеФАКТОРИАЛАИспользуяПредопределенныйФункциональныйИнтерфейс;

import java.util.function.Function;

public class FactorialUseFunctionInterface {
